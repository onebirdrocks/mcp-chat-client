...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ className = '' }) => {
  ...
  if (!currentSession) {
    return (
      <div className={`h-full flex flex-col items-center justify-center bg-white dark:bg-gray-800 p-8 ${className}`}>
  ...
  return (
    <div className={`chat-interface h-full flex flex-col bg-white dark:bg-gray-800 ${className}`} role="main" aria-label={t('chat.chatInterface', 'Chat interface')}>
